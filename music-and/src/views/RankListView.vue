                            ...
                            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                                <table v-if="songs.length > 0" class="min-w-full divide-y divide-gray-300">
                                    <thead>
                                        <tr>
                                            <th scope="col"
                                                class="py-2 pl-4 pr-3 text-left text-xs font-semibold text-gray-500 sm:pl-3 w-1/3">
                                                歌曲信息</th>
                                            <th scope="col"
                                                class="px-3 py-2 text-left text-xs font-semibold text-gray-500 w-1/6">喜欢
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-2 text-left text-xs font-semibold text-gray-500 w-1/10">
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-2 text-left text-xs font-semibold text-gray-500 w-1/4">专辑
                                            </th>
                                            <th scope="col"
                                                class="px-3 py-2 text-left text-xs font-semibold text-gray-500 w-1/6">时长
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody class="bg-white">
                                        <tr v-for="(song, index) in songs" :key="song.songId"
                                            class="even:bg-gray-50 cursor-pointer" @mouseenter="hoveredIndex = index"
                                            @mouseleave="hoveredIndex = -1" @click="handleSongClick(song)"
                                            ...
                                            <td
                                                ...
                                                <div class="flex items-center">
                                                    <img class="inline-block h-10 w-10 rounded-md mr-2"
                                                        :src="song.coverPath" alt="" />
                                                    <div>
                                                        <p>{{ song.title }}</p>
                                            ...
                                            <td class="whitespace-nowrap px-3 py-2 text-sm text-gray-500 pl-2 w-1/6">
                                                ...
                                                <button @click.stop="toggleLike(index)" class="flex items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        :fill="song.isLiked ? 'red' : 'none'" viewBox="0 0 24 24"
                                            ...
                                            <td
                                                class="whitespace-nowrap px-3 py-2 text-sm text-gray-500 relative w-1/10 text-left">
                                                <svg v-if="hoveredIndex === index" xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <td
                                                class="whitespace-nowrap px-3 py-2 text-sm text-gray-500 relative w-1/4">
                                                {{ song.album }}
                                            </td>
                                            <td class="whitespace-nowrap px-3 py-2 text-sm text-gray-500 w-1/6">{{
                                                song.duration }}</td>
                                        </tr>
                                    </tbody>
                                </table>
